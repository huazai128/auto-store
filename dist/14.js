...
var _default = (_dec = (0, _mobxReact.inject)(function (stores) {
	return { store: stores.reportInventory };
	...
	_createClass(_default, [{
		...
		value: function render() {
			var _props$part = this.props.part,
			    ...
			    DatePicker = _props$part.DatePicker,
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_Layout.HandleArea,
						{ className: 'flex' },
						_react2.default.createElement(ExportGroup, { style: { marginLeft: -20 } }),
						_react2.default.createElement(DatePicker, { value: this.store.query.time, allowClear: false })
					),

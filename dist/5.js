...
var _ModalAdd = __webpack_require__(1260);
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								HandleButton,
								{ method: 'invoke', state: 'created', icon: 'check-circle-o' },
								'\u5E94\u7528'
							),
							_react2.default.createElement(
								HandleButton,
								{ method: 'uninvoke', state: 'invoked_no', icon: 'close-circle-o' },
								'\u53CD\u5E94\u7528'
							)
						),
						_react2.default.createElement(
					...
					_react2.default.createElement(MainTable, { edit: true, title: this.props.name })
				)
			);
		}
	}]);
...
var _default = (_dec = (0, _mobxReact.inject)(function (stores) {
...
}), _dec(_class = (0, _modal2.default)(_class = (0, _mobxReact.observer)(_class = function (_Component) {
	_inherits(_default, _Component);
	...
	function _default() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(_ref, [this].concat(args))), _this), _this.handleSubmit = function (e) {
			e.preventDefault();
						...
						while (1) {
							switch (_context.prev = _context.next) {
								case 0:
									...
									_context.prev = 4;
									_context.next = 7;
									return _this.props.product.create(values);
								...
								case 11:
									...
									_this.props.onConfirmLoading(false);
	...
	_createClass(_default, [{
		key: 'render',
		value: function render() {
			var fields = this.props.product.fields;
			var HocModal = this.props.HocModal;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_Form2.default, { ref: 'form', fields: [].concat(_toConsumableArray(fields))
				})
			);
		}
	}]);

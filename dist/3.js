...
var _default = (_dec = (0, _mobxReact.inject)(function (store) {
	...
	function _default() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(_ref, [this].concat(args))), _this), _this.columns = [{ width: 200, title: '货品', key: 'number' }, { width: 150, title: '货品名称', key: 'name' }, { width: 80, title: '采购价', key: 'costPrice' }, { width: 80, title: '结算价', key: 'price' }, { width: 100, title: '采购数量', key: 'amount', edit: { type: 'number' } }, { width: 200, title: '备注', key: 'note' }], _this.computedQuery = function (value) {

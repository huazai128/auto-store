...
var AddStoreModal = (_dec = (0, _mobxReact.inject)('store'), _dec(_class = (0, _modal2.default)(_class = (0, _mobxReact.observer)(_class = function (_Component) {
						...
						while (1) {
							switch (_context.prev = _context.next) {
								case 0:
									...
									_context.next = 4;
									return _this.props.store.create(values);
	...
	_createClass(AddStoreModal, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(_Form2.default, { ref: 'form', fields: [].concat(_toConsumableArray(this.props.store.fields)) })
			);
		}
	}]);
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							DeleteButton,
							{ state: 'created_no', confirm: { title: '确定删除选中门店？' } },
							'\u5220\u9664'
						),
						_react2.default.createElement(
							AddStoreModal,

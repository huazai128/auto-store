...
var ReferModal = (0, _modal2.default)(_class = (0, _mobxReact.observer)(_class = function (_Component) {
	...
	function ReferModal(props) {
		...
		_this.handleSubmit = function () {
			...
			if (!result) return _antd.Modal.error({
				title: '存在入库货品未绑定采购单！',
				content: '无法完成参照制单...'
			});
		...
		_this.columns = [{
			width: 15, title: '', key: 'dilidili', render: function render(_, record) {
				...
				return _react2.default.createElement(_antd.Icon, { className: (orderAmountMap.some(function (i) {
						return i.selected;
		...
		// { width: 80, title: '入库数量', key: 'bindedAmount', type: 'info' },
		{
			width: 80, title: _react2.default.createElement(
				...
				return _react2.default.createElement(_antd.InputNumber, { max: record.bound, min: 0, value: record.bindedAmount, onChange: function onChange(value) {
					...
					title: _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								null,
								_react2.default.createElement(_antd.Icon, { className: 'fs16 primary-6 mr10', type: 'link' }),
								_react2.default.createElement(
									'span',
									{ className: 'fs12' },
									'\u8D27\u54C1',
							...
							_react2.default.createElement(
								'div',
								null,
								_react2.default.createElement(_antd.Icon, { className: 'fs16 ml50 mr10', type: 'link' }),
								_react2.default.createElement(
									'span',
									{ className: 'fs12' },
									'\u8D27\u54C1\u672A\u7ED1\u5B9A\u91C7\u8D2D\u5355'
...
// module
exports.push([module.i, ".style-left__DKey_ {\n  height: 600px;\n  background-color: #f5f9fd;\n}\n.style-right__10c2m {\n  height: 600px;\n  padding: 0 10px;\n}\n.style-right__10c2m .ant-table-middle .ant-table-title {\n  padding: 4px 8px;\n}\n", "", {"version":3,"sources":["C:/Users/Administrator/Desktop/dyun/auto-store/app/view/Storage/style.less"],"names":[],"mappings":"AAAA;EACE,cAAc;EACd,0BAA0B;CAC3B;AACD;EACE,cAAc;EACd,gBAAgB;CACjB;AACD;EACE,iBAAiB;CAClB","file":"style.less","sourcesContent":[".left {\n  height: 600px;\n  background-color: #f5f9fd;\n}\n.right {\n  height: 600px;\n  padding: 0 10px;\n}\n.right :global .ant-table-middle .ant-table-title {\n  padding: 4px 8px;\n}\n"],"sourceRoot":""}]);

...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__grid__ = __webpack_require__(1242);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__style_index_less__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__style_index_less___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__style_index_less__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__grid_style_index_less__ = __webpack_require__(501);
...
// module
exports.push([module.i, ".style-left__DKey_ {\n  height: 600px;\n  background-color: #f5f9fd;\n}\n.style-right__10c2m {\n  height: 600px;\n  padding: 0 10px;\n}\n.style-right__10c2m .ant-table-middle .ant-table-title {\n  padding: 4px 8px;\n}\n", ""]);

// exports
exports.locals = {
	"left": "style-left__DKey_",
	"right": "style-right__10c2m"
};
...
var _row = __webpack_require__(1261);

var _row2 = _interopRequireDefault(_row);

var _col = __webpack_require__(1262);
...
var _style = __webpack_require__(1265);
...
var ReferModal = (0, _modal4.default)(_class = (0, _mobxReact.observer)(_class = function (_Component) {
	_inherits(ReferModal, _Component);
	...
	function ReferModal(props) {
		...
		_this.handleInput = function (value, record) {
			value = value || 0;
			record.bindedAmount = value;
			// ============================================================
			_this.props.data.forEach(function (item) {
				var amount = 0;
				item.orderAmountMap.filter(function (i) {
					return i.selected;
				}).forEach(function (i) {
					return amount += i.bindedAmount;
				});
				item.amount = amount;
			});
		...
		_this.handleSubmit = function () {
			...
			data.forEach(function (item) {
				if (!item.orderAmountMap.some(function (i) {
					return i.selected;
				})) result = false;
				var amount = 0;
				item.orderAmountMap.filter(function (i) {
			...
			if (!result) return _modal2.default.error({
				title: '存在入库货品未绑定采购单！',
				content: '无法完成参照制单...'
			});
		...
		_this.onRowClick = function (record) {
			_this.props.data.forEach(function (item) {
				if (item === record) item.highlight = true;else item.highlight = false;
			});
			_this.props.update();
		};

		_this.addPro = function () {
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(item) {
				var skuId, _this$props, supplierId, warehouseId, _ref2, data;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								...
								if (!_this.props.data.map(function (i) {
									return i.key;
								}).includes(item.key)) {
									_context.next = 3;
									break;
							...
							case 3:
								skuId = item.id;
								_this$props = _this.props, supplierId = _this$props.supplierId, warehouseId = _this$props.warehouseId;
								_context.next = 7;
								return (0, _request.get)('/api/purchaseOrders/forStockIn', { skuId: skuId, supplierId: supplierId, warehouseId: warehouseId, showInvalid: false });
		...
		_this.columns = [{
			width: 15, title: '', key: 'dilidili', render: function render(_, record) {
				var orderAmountMap = record.orderAmountMap;


				return _react2.default.createElement(_icon2.default, { className: (orderAmountMap.some(function (i) {
						return i.selected;
					}) ? 'primary-6' : '') + ' fs16', type: 'link' });
			}
		}, { width: 100, title: '货品名', key: 'name' }, {
			width: 30, title: '', key: 'delete', render: function render(_, record) {
				var style = {
					cursor: 'pointer',
					padding: 10
				};
		...
		_this.columns2 = [{ width: 150, title: '采购单号', key: 'sequence' }, { width: 180, title: '收货仓店编号及名称', key: 'warehouse' }, { width: 180, title: '供应商编号及名称', key: 'supplier' }, { width: 80, title: '采购数量', key: 'amount' }, { width: 80, title: '已入库数', key: 'stockInAmount' }, { width: 80, title: '未入库数', key: 'unbound' },
		// { width: 80, title: '入库数量', key: 'bindedAmount', type: 'info' },
		{
			width: 80, title: _react2.default.createElement(
				'div',
				{ className: 'primary-6' },
				'\u5165\u5E93\u6570\u91CF'
			), key: '_bindedAmount', render: function render(_, record) {
				// return record.bindedAmount;
				return _react2.default.createElement(_inputNumber2.default, { max: record.bound, min: 0, value: record.bindedAmount, onChange: function onChange(value) {
						return _this.handleInput(value, record);
					} });
			}
	...
	_createClass(ReferModal, [{
		...
		value: function render() {
			...
			var _record = record,
			    _record$orderAmountMa = _record.orderAmountMap,
			    orderAmountMap = _record$orderAmountMa === undefined ? [] : _record$orderAmountMa;


			var selectedRowKeys = orderAmountMap.filter(function (i) {
				return i.selected;
			}).map(function (i) {
				return i.key;
			});
			...
			var rowSelection = {
				onChange: function onChange(selectedRowKeys, selectedRows) {
					orderAmountMap.forEach(function (i) {
						if (selectedRowKeys.includes(i.key)) i.selected = true;else i.selected = false;
					});
					...
					_this3.props.update(_this3.props.data);
				},
			...
			return _react2.default.createElement(
				HocModal,
				{
					title: _react2.default.createElement(
						'div',
						{ className: 'flex-vcenter jc-between' },
						_react2.default.createElement(
							'div',
							null,
							'\u53C2\u7167\u5236\u5355'
						...
						_react2.default.createElement(
							'div',
							{ className: 'flex', style: { color: 'rgba(0, 0, 0, 0.65)' } },
							_react2.default.createElement(
								'div',
								null,
								_react2.default.createElement(_icon2.default, { className: 'fs16 primary-6 mr10', type: 'link' }),
								_react2.default.createElement(
									'span',
									{ className: 'fs12' },
									'\u8D27\u54C1',
							...
							_react2.default.createElement(
								'div',
								null,
								_react2.default.createElement(_icon2.default, { className: 'fs16 ml50 mr10', type: 'link' }),
								_react2.default.createElement(
									'span',
									{ className: 'fs12' },
									'\u8D27\u54C1\u672A\u7ED1\u5B9A\u91C7\u8D2D\u5355'
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_col2.default,
						{ className: _style2.default.left + ' flex-col', span: 5 },
						_react2.default.createElement(
							'div',
							{ style: { padding: 10 } },
							_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_Basic2.default, {
								onRow: function onRow(record, index) {
									return {
										onClick: _this3.onRowClick.bind(_this3, record)
									};
								},
								scroll: { y: 360 },
								dataSource: data,
								rowClassName: function rowClassName(r) {
									return r === record ? 'active' : '';
								},
								columns: this.columns,
								pagination: false })
						),
						_react2.default.createElement('div', { className: 'flex-g-1' }),
						_react2.default.createElement(
							'div',
							{ style: { textAlign: 'center', marginBottom: 10 } },
							_react2.default.createElement(
								_button2.default,
								{ onClick: this.handleSubmit, style: { width: 150 }, type: 'primary', size: 'large' },
								'\u5B8C\u6210'
							)
						)
					),
					_react2.default.createElement(
						_col2.default,
						{ className: _style2.default.right, span: 19 },
						_react2.default.createElement(_Basic2.default, {
...
var _default = (_dec = (0, _mobxReact.inject)(function (store) {
	return {
		body: store.body,
...
}), _dec(_class3 = _dec2(_class3 = (0, _mobxReact.observer)(_class3 = function (_Component2) {
	...
	function _default() {
		...
		return _ret = (_temp = (_this4 = _possibleConstructorReturn(this, (_ref3 = _default.__proto__ || Object.getPrototypeOf(_default)).call.apply(_ref3, [this].concat(args))), _this4), _this4.columns = [{ width: 200, title: '货品', key: 'number' }, { width: 150, title: '货品名称', key: 'name' }, { width: 80, title: '采购价', key: 'costPrice' }, { width: 80, title: '结算价', key: 'price' }, { width: 100, title: '本次入库数量', key: 'amount', type: 'info' }, { width: 80, title: '采购价总额', key: 'costPriceall', render: function render(_, record) {
				return _react2.default.createElement(
					'p',
					null,
					(record.amount * record.costPrice).toFixed(2)
				);
			} }, { width: 80, title: '结算价总额', key: 'priceall', render: function render(_, record) {
				return _react2.default.createElement(
					'p',
					null,
					(record.amount * record.price).toFixed(2)
				);
			} }, { width: 200, title: '备注', key: 'note', edit: {} }], _this4.computedQuery = function (value) {
			value.items = value.items.map(function (item) {
				return {
					skuId: item.id,
					note: item.note,
					orderAmountMap: item.orderAmountMap.filter(function (i) {
						return i.selected;
					}).map(function (i) {
						return {
							orderId: i.id,
	...
	_createClass(_default, [{
		...
		value: function render() {
			...
			var _props2 = this.props,
			    BackCreateHearder = _props2.BackCreateHearder,
			    RenderCreateTable = _props2.RenderCreateTable,
			    BindedFormItem = _props2.BindedFormItem,
			    RenderUpload = _props2.RenderUpload,
			    handleSubmit = _props2.handleSubmit,
			    addItems = _props2.addItems,
			    toWarehouseField = _props2.toWarehouseField,
			    fromWarehouseField = _props2.fromWarehouseField,
			    warehouseField = _props2.warehouseField,
			    supplierField = _props2.supplierField;

			var _props$form$getFields = this.props.form.getFieldsValue(),
			    supplierId = _props$form$getFields.supplierId,
			    warehouseId = _props$form$getFields.warehouseId,
			    toWarehouseId = _props$form$getFields.toWarehouseId,
			    fromWarehouseId = _props$form$getFields.fromWarehouseId;

			return _react2.default.createElement(
				_Layout.Container,
				null,
				_react2.default.createElement(BackCreateHearder, { handleSubmit: function handleSubmit() {
						return _this5.props.handleSubmit(_this5.computedQuery);
					} }),
				_react2.default.createElement(
					_Layout.Content,
					{ style: { padding: 10 } },
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(_datePicker2.default, { allowClear: false })
								),
								warehouseField,
								supplierField
							),
						...
						title: function title() {
							return _react2.default.createElement(
								...
								_react2.default.createElement(
									ReferModal,
									{
										data: _this5.props.items,
										deleteItem: _this5.props.deleteItem,
										addItems: _this5.props.addItems,
										update: _this5.props.update,
										warehouseId: warehouseId,
										supplierId: supplierId },
									_react2.default.createElement(
										_button2.default,
										{ disabled: !supplierId || !warehouseId, type: 'primary', className: 'ml20' },
										'\u53C2\u7167\u5236\u5355'
									)
								)
							);
